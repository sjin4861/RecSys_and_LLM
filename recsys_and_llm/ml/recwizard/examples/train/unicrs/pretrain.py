...
from recwizard.modules.unicrs import UnicrsRec, UnicrsRecConfig, UnicrsRecTokenizer
from recwizard.tokenizer_utils import BaseTokenizer
from recwizard.utility import DeviceManager, batchify, init_deterministic, pad_and_stack
        ...
        for batch in dataloader:
            with torch.no_grad():
                loss, outputs = self.compute_loss(
                    self.model, batch, return_outputs=True
                )
...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="save/unicrs_pre/redial",
