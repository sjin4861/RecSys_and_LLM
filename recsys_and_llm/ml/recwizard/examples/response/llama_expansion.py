...
from recwizard.modules.chatgpt import LlamaGen, LLMConfig
...
if __name__ == "__main__":
    ...
    query = (
        "User: Hi I am looking for movies like <entity>Super Troopers (2001)</entity>"
