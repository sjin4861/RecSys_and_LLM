...
from recwizard.modules.chatgpt import ChatgptGen, ChatgptRec
from recwizard.pipelines.chatgpt import ChatgptAgent, ChatgptAgentConfig
...
if __name__ == "__main__":
    ...
    query1 = (
        "User: Hi. I like everything but <entity>fantasy</entity> films and alien type stuff."
