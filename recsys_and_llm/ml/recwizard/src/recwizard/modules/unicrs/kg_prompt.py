...
import torch
from recwizard.utility import Singleton, deterministic_seed
...
class KGPrompt(nn.Module):
    def __init__(
        ...
        self.text_encoder = Singleton(
            "unicrs.KGPrompt.text_encoder", AutoModel.from_pretrained("roberta-base")
        )
