...
class CRSToolkitMonitor:
    r"""CRSToolkitMonitor static class to wrap module/model response method for debugging purposes.
    ...
    def monitor(cls, function):
        def function_wrapper(*args, **kwargs):
            ...
            end_time = time.time()
            output = (
                {k: v for k, v in result.items() if serializable(v)}
